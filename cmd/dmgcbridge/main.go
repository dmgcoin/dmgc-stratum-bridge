...
import (
	...
	"github.com/dmgcoin/dmgcstratum/src/dmgcstratum"
	"gopkg.in/yaml.v2"
)
...
func main() {
	...
	flag.StringVar(&cfg.RPCServer, "dmgc", cfg.RPCServer, "address of the dmgc node, default `localhost:16110`")
	...
	log.Printf("\tdmgc:            %s", cfg.RPCServer)
	...
	if err := dmgcstratum.ListenAndServe(cfg); err != nil {
		log.Println(err)
	}
}
